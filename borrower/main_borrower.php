...
<head>
    ...
    <link rel="stylesheet" href="main_borrower.css">
    ...
    <div id="maincontainer">
        <div id="container">
            <div id="menu">
                ...
                <div class="items">
                    ...
                    <div class="linkk">
                        <a id="special" href="#">Borrowers &nbsp; <i class="fa fa-caret-left"></i></a>
        ...
        <div id="container2">
            ...
            <div id="main">
                ...
                $sql3 = "SELECT MAX(ID) FROM borrower";
                ...
                <div class="mdform">
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        $sql = "INSERT INTO `borrower`(`ID`, `Name`, `Contact`, `Email`, `Address`) VALUES ('$id', '$name', '$contact', '$email', '$add')";
                        $result = mysqli_query($conn, $sql) or die("QUERY ERROR");

                        // $sql2 = " ALTER TABLE borrower CHANGE ID INT(10) NOT NULL AUTO_INCREMENT PRIMARY KEY";
                        // $res2 = mysqli_query($conn, $sql2) or die("primary key error");

                        $sql1 = "ALTER TABLE borrower AUTO_INCREMENT=1";
                    ...
                    ?>
                            <script>
                                ...
                                // clearTimeout(clr);
                                location.replace("main_borrower.php");
                            </script>
                        ...
                        ?>
                            <script>
                                document.getElementById('showw').innerHTML = "NEW borrower ADDITION HAS BEEN FAILED";
                                document.getElementById('showw').style.display = "block";
