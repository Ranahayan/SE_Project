...
<head>
    ...
    <link rel="stylesheet" href="edit_employe.css">
        ...
        <div id="container">
            <div id="menu">
                ...
                <div class="items">
                    ...
                    <div class="link">
                        <a class="ddd" href="main_emp.php">Employees</a>
                    </div>
                </div>
            </div>
        </div>
        <div id="container2">
            ...
            <div id="main">
                ...
                ?>
                    ...
                    <?php
                    $sql = "SELECT * FROM `employee` WHERE `ID`='$search_idd'";
                ...
                if (isset($_POST['UPD'])) {
                    ...
                    $sql1 = "UPDATE `employee` SET `Name`='$name',`Contact`='$contact',`Email`='$email',`Address`='$add' WHERE ID = '$id' ";
                ...
                if (isset($_POST['del'])) {
                    ...
                    $sql3 = "SELECT * FROM `employee` WHERE ID > '$s_id'";
                    $reslt4 = mysqli_query($conn, $sql3) or die("SEL_QUERY ERROR");


                    $sql2 = "DELETE FROM `employee` WHERE ID='$s_id'";
                    $result3 = mysqli_query($conn, $sql2);
                   
                    if (mysqli_num_rows($reslt4) > 0) {

                        $sql4 = "DELETE  FROM `employee` WHERE ID > '$s_id'";
                        $result5 = mysqli_query($conn, $sql4) or die("DEL_QUERY ERROR");

                        $sql5 = "ALTER TABLE employee AUTO_INCREMENT = $s_id";
                        ...
                        while($row = mysqli_fetch_array($reslt4)){
                           ...
                           $sql6 =  "INSERT INTO `employee`(`ID`, `Name`, `Contact`, `Email`, `Address`) VALUES ('$id1','$name1','$contact1','$email1','$add1')";
